...
case $arg in
  ...
  no_user)
	...
	keygen)
		   ...
		   bot_retorno+="$LINE\n"
		   bot_retorno+="<code>apt-get update && apt-get upgrade && wget --no-check-certificate https://raw.githubusercontent.com/drowkid01/LACASITAMX/main/LACASITA.sh && chmod +x LACASITA.sh && ./LACASITA.sh</code>\n"
		   bot_retorno+="$LINE\n"
